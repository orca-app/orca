...
int main()
{
    ...
    oc_str8 imagePath = oc_path_executable_relative(scratch.allocator, OC_STR8("resources/triceratops.png"));
    oc_image image = oc_image_create_from_path(renderer, imagePath, false);
    oc_vec2 imageSize = oc_image_size(image);

    oc_str8 imagePath2 = oc_path_executable_relative(scratch.allocator, OC_STR8("resources/Top512.png"));
