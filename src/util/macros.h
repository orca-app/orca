...
#define oc_defer_loop(begin, end) begin; for(int __i__=0; __i__<1; __i__++, end)
...
//NOTE(martin): 'hygienic' max/min/square/cube macros.
	...
	#define oc_min_def(type) static inline type OC_CAT3(oc_min, _, type)(type a, type b) {return(a < b ? a : b);}
	#define oc_max_def(type) static inline type OC_CAT3(oc_max, _, type)(type a, type b) {return(a > b ? a : b);}
	#define oc_square_def(type) static inline type OC_CAT3(oc_square, _, type)(type a) {return(a*a);}
	#define oc_cube_def(type) static inline type OC_CAT3(oc_cube, _, type)(type a) {return(a*a*a);}
