...
oc_str8_list oc_path_split(oc_allocator* allocator, oc_str8 path)
{
    ...
    else if(oc_path_starts_with_volume_letter(path))
    {
        ...
        oc_str8_elt* firstElt = oc_typed_list_first(res.list);
    ...
    oc_typed_list_for_safe(res.list, elt)
    {
        if(elt->string.len == 0)
        {
...
oc_str8 oc_path_join(oc_allocator* allocator, oc_str8_list elements)
{
    ...
    oc_str8_list_for(elements, elt)
    {
        ...
        if(elt->string.len)
        {
            ...
            if(elt == oc_typed_list_first(elements.list) && start != 0)
            {
                start--;
            }
            ...
            if(elt == oc_typed_list_last(elements.list) && end != elt->string.len)
            {
                end++;
            }
            ...
            // or 1 separator
            if(elt == oc_typed_list_first(elements.list)
            ...
            else
            {
                ...
                if(slice.len || elt == oc_typed_list_first(elements.list) || elt == oc_typed_list_last(elements.list))
                {
