...
ORCA_API oc_file_open_with_dialog_result oc_file_open_with_dialog(oc_allocator* allocator, oc_file_access rights, oc_file_open_flags flags, oc_file_dialog_desc* desc);
