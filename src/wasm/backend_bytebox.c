...
// static char oc_wasm_valtype_to_bytebox_valtype(oc_wasm_valtype valtype)
// {
//     switch(valtype)
//     {
//         case OC_WASM_VALTYPE_I32:
...
// static const void* oc_wasm_binding_bytebox_thunk(IM3Runtime runtime, IM3ImportContext ctx, uint64_t* stack, void* mem)
// {
//     const oc_wasm_binding_bytebox* binding = (oc_wasm_binding_bytebox*)ctx->userdata;
...
oc_wasm_status oc_wasm_decode(oc_wasm* wasm, oc_str8 wasmBlob)
{
    ...
    // return oc_wasm_handle_bytebox_result(wasm, res, "The application couldn't parse its web assembly module");
}
...
oc_wasm_status oc_wasm_mem_resize(oc_wasm* wasm, u32 countPages)
{
    ...
    // if(res)
    // {
    //     return oc_wasm_handle_bytebox_result(wasm, res, "Failed to resize wasm memory");
    // }
