...
const LibShas = struct {
    ...
    fn find(cwd: std.fs.Dir, allocator: std.mem.Allocator) !LibShas {
        ...
        const contents: []const u8 = try cwd.readFileAlloc(allocator, "build.zig.zon", MAX_FILE_SIZE);
...
pub fn build(b: *Build) !void {
    ...
    const angle_build_dir = stage_angle_repo.addCopyDirectory(angle_dep.path(""), "build/angle", .{});
